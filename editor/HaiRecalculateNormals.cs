...
namespace RykerTM.Tools.RBSN.Hai
{
	public class NormalCalculator
	{
		public static void RecalculateNormalsOf(SkinnedMeshRenderer smr, List<string> thatSmrBlendShapes, List<string> applicableBlendShapes, List<string> eraseCustomSplitNormalsBlendShapes)
		{
